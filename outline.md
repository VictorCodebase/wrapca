...
- `GeoTiffBandReaderService` reads exactly 5 bands from the 11-band CV file — band indices are constants in `BandLayout`, single file to update if CV changes its layout. CRS: EPSG:32737, native pixel size: 10m
